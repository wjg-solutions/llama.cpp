...
struct common_params {
    ...
    int32_t beam_width            =     1; // beam width for beam search decoding (1 = greedy)
    ...
    bool    beam_deterministic    =  true; // enable deterministic beam search with consistent tie-breaking
